...
public class SAMProxyControllerTests {
	...
	public void postInvalidCampaignTargetDto() throws IOException, Exception {
		...
		dto.setContactNumbers(new String[1000000]);
		 ...
		 mockMvc.perform(post("/createOrUpdateTarget")
	...
	public void testValidation() {
		CampaignTargetDto dto = new CampaignTargetDto();
		dto.setCode("1234!"); //invalid character (!)
		dto.setInternalName("AbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghijAbcdefghij"); 
		dto.setContactNumbers(new String[1000000]);
		...
		Assert.assertTrue("Message", constraintViolations.size() == 1);
...
29
	...
	public JSONObject createOrUpdateTarget(@RequestBody @Valid CampaignTargetDto campaignTargetDto) {
